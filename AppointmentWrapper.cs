...
namespace VSTO_AddIn
{
	...
	public class AppointmentEventWrapper : ItemEvents10Ex, IDisposable
	{
		...
		public AppointmentEventWrapper(Outlook.AppointmentItem appointmentItem)
		{

			IConnectionPointContainer pConnectionPointContainer = appointmentItem as IConnectionPointContainer;
